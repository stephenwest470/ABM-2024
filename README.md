...
## Context
The simulation used in this paper (sim9-1.3) is based on the code that was used in Matsumoto & Sasakura (2016). It has been made publicly available here, with permission.
